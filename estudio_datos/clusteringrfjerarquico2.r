...
campos_buenos  <- c( "ctrx_quarter", "cpayroll_trx", "mcaja_ahorro", "mtarjeta_visa_consumo", "ctarjeta_visa_transacciones",
                     ...
                     "mpagomiscuentas", "ctarjeta_debito_transacciones", "mprestamos_prendarios", "mprestamos_hipotecarios",
                     "mpagodeservicios", "Master_delinquency", "Master_Finiciomora", "Master_mlimitecompra",
                     "Visa_delinquency", "Visa_Finiciomora", "Visa_mlimitecompra")
...
Rango(dataset, campos_buenos)

cols_nrank <- paste0( campos_buenos, "_nrango")
...
for(variable_ahora in campos_buenos){
  tryCatch({
    ...
    ggsave(paste0("/home/leandroriverogonzalez/dmeyf/estudio_datos/cluster2/",variable_ahora,"_histogram_per_month.pdf"))
