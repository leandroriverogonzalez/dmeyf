...
palancas$version  <- "vbisturitend14**_leandro"   #Muy importante, ir cambiando la version
...
Corregir  <- function( dataset )
{
  ...
  dataset[ foto_mes==202007,  mextraccion_autoservicio  := NA ]
  dataset[ foto_mes==202007,  mtarjeta_visa_consumo  := NA ]
...
CanaritosImportancia  <- function( dataset )
{
  ...
  entrenamiento  <-  dataset[ , foto_mes>= 202007 &  foto_mes<= 202010 &  foto_mes!=202006 & ( clase01==1 | azar < 0.10 ) ]
