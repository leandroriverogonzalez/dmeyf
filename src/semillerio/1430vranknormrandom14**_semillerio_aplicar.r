...
karch_dataset  <- "./datasets/dataset_epic_vranknormrandom14**_leandro.csv.gz"
#karch_dataset  <- "./datasets/semillerio_dataset_lag1.csv.gz"
ksalida  <- "dataset_epic_vranknormrandom14**vmin_leandro" 

#E1021_1420vranknormrandom14**vmin_lgbm_BOlog.txt
...
x  <- list()
x$gleaf_size   <- 66.8118359604478
x$gnum_leaves  <- 0.235761824885584
x$learning_rate <- 0.129499947671555
x$feature_fraction <- 0.734088856905722
x$num_iterations  <- 125
