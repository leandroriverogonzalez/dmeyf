...
karch_dataset  <- "./datasets/dataset_epic_vranknorm14**nvarsl2d2vmin_leandro.csv.gz"
#karch_dataset  <- "./datasets/semillerio_dataset_lag1.csv.gz"
ksalida  <- "vranknorm14**nvarsl2d2vmin_leandro" 

#E1024_1420vranknorm14**nvarsl2d2vmin_lgbm_BOlog.txt
...
x  <- list()
x$gleaf_size   <- 62.2289842707564
x$gnum_leaves  <- 0.610331371484547
x$learning_rate <- 0.184751306080488
x$feature_fraction <- 0.117608658921338
x$num_iterations  <- 119
