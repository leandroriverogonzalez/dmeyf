...
karch_dataset  <- "./datasets/dataset_epic_vranknormtendencia14**_leandro.csv.gz"
#karch_dataset  <- "./datasets/semillerio_dataset_lag1.csv.gz"
ksalida  <- "vranknormtendencia14**vmin_leandro" 

#E1023_1420vranknormtendencia14**_lgbm_BOlog.txt
...
x  <- list()
x$gleaf_size   <- 62.6569739727117
x$gnum_leaves  <- 0.26061946789236
x$learning_rate <- 0.160164414017261
x$feature_fraction <- 0.10143674648914
x$num_iterations  <- 182
