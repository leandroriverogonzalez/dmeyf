...
karch_dataset  <- "./datasets/dataset_epic_vranknorm14**_leandro.csv.gz"
#karch_dataset  <- "./datasets/semillerio_dataset_lag1.csv.gz"
ksalida  <- "vranknorm14**vmin_leandro" 
...
x  <- list()
x$gleaf_size   <- 48.3150204856184
x$gnum_leaves  <- 0.481171790700474
x$learning_rate <- 0.189566678176714
x$feature_fraction <- 0.191664234213657
x$num_iterations  <- 258
